 ...
 * CLI version: 2.12.0
 *
 * Generated: Tue, 29 Aug 2023 11:44:43 GMT
 */

var APP_com_domain_app_player2 = (function () {
  'use strict';
  ...
  // Define the HoleShader class if it's not already defined
  class HoleShader extends Lightning$1.shaders.TextureShader {
    constructor() {
      super();
      this.uniforms.add('hole', [0, 0, 1920, 1080]);
    }
  }
  class App extends Lightning$1.Component {
    static _template() {
      return {
        ...
        Video: {
          ...
          videoTag: true,
          // This will create an HTML video element
          shader: {
            type: HoleShader,
            x: 0,
            y: 0,
    ...
    _init() {
      ...
      this._videoElement = this.tag('Video').video;

      // Set the video source
      this._videoElement.src = "aamps://dash.akamaized.net/dash264/TestCasesMCA/dolby/3/1/ChID_voices_20_128_ddp.mpd";

      // // Autoplay the video
      this._videoElement.play();

      // // Enable RTT (Render To Texture) when HoleShader is used
      this.shader.hole = [0, 0, 1920, 1080]; // Set hole dimensions to match Video dimensions
      this.rtt = true;
    }
  }
