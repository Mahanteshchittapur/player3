 ...
 * CLI version: 2.12.0
 *
 * Generated: Wed, 30 Aug 2023 13:05:49 GMT
 */
...
var APP_com_domain_app_player3 = (function () {
  ...
  class App extends Lightning$1.Component {
    ...
    _init() {
      ...
      this._keyDown = this.tag("PlayButton").on("keydown", this._onKeyDown);
    }
    _handleKeyDown(event) {
      if (event.keyCode === 13) {
        // Enter key was pressed, play the video
        this.playVideo();
      }
    }
    _firstActive() {
    ...
    _inactive() {
      // Unsubscribe from the key down event when the component becomes inactive
      this.tag("PlayButton").off("keydown", this._onKeyDown);
    }
  }
